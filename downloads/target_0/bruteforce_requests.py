...
Vergleich:
    ...
    - Funktioniert Ã¼berall (keine WSL nÃ¶tig)
============================================
"""
...
FAIL_STRING = "UngÃ¼ltige Eingabedaten"  # Fehlermeldung bei falschem Login
...
def try_login(session, username, password):
    ...
    try:
        ...
        # PrÃ¼fe Response-Text auf Fehlermeldung
...
def main():
    ...
    # Session erstellen (behÃ¤lt Cookies)
